...
@application.route('/mongodb_search_email', methods=['POST'])
...
@application.route('/mongodb_update', methods=['POST'])
def mongodb_update():
    if request.is_json:
        data = request.get_json()
        # print(data)
...
@application.route('/mongodb_create', methods=['POST'])
def mongodb_create():
    if request.is_json:
        data = request.get_json()
        email = data.get('email')
...
@application.route('/insertintotable', methods=['POST'])
def insertintotable():
    if request.is_json:
        data = request.get_json()
        nm = data.get('nm')
